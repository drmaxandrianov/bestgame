...
function processKeys() {
    if (keyMap.left) {
        gameObjects.avatars[settings.playersAvatarId].translate(-settings.avatarTranslateSpeed, 0);
    }
    if (keyMap.right) {
        gameObjects.avatars[settings.playersAvatarId].translate(settings.avatarTranslateSpeed, 0);
    }
    if (keyMap.up) {
        gameObjects.avatars[settings.playersAvatarId].translate(0, -settings.avatarTranslateSpeed);
    }
    if (keyMap.down) {
        gameObjects.avatars[settings.playersAvatarId].translate(0, settings.avatarTranslateSpeed);
    }
